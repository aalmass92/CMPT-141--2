...
black_box1 = [ {'inputs' : ['master@sol.aea.edu'],
               'outputs': True,
               'reason' : 'Identifier, college, and "aea.edu" present'},
              {'inputs' : ['apprentice1902@aea.edu.sol'],
               'outputs': False,
               'reason' : '"aea.edu" present, but invalid location'},
              {'inputs' : ['duchess@sol@aea.edu'],
               'outputs': False,
               'reason' : "'@' can not be used as part of an identifier or college"},
              {'inputs' : ['duchess@aea.edu'],
               'outputs': True,
               'reason' : "No college given, but that's allowable."}
              ]
