...
def prov_percent_vaccinated_in_age_range(Covid_Data,Province,lowAge,highAge ):
    ...
    """
    Def: function that calculates province vaccinated
    :param Covid_Data: list of a list of covid data, age range, vac pop, pop, province
    :param Province: string representing province
    :param lowAge: inst value that represents low age
    :param highAge: int value that represents
    :return: float value (percentProvAge) that represents percentage of vaccinated from parameters
    """
